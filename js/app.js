(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-business")) new core(".slider-business", {
            ...
            pagination: {
                el: ".business__slider .controls-business__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".business__slider .slider-arrows__button_prev",
                nextEl: ".business__slider .slider-arrows__button_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-inspiration__slider")) new core(".slider-inspiration__slider", {
            modules: [ Navigation, Pagination, Parallax, Autoplay ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            navigation: {
                prevEl: ".slider-inspiration__arrows .slider-arrows__button_prev",
                nextEl: ".slider-inspiration__arrows .slider-arrows__button_next"
            },
            on: {}
        });
        if (document.querySelector(".slider-tips__slider")) new core(".slider-tips__slider", {
            ...
            navigation: {
                prevEl: ".slider-tips__arrows .slider-arrows__button_prev",
                nextEl: ".slider-tips__arrows .slider-arrows__button_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.1,
...
***************************************************************************** */
    ...
    if (gallery && !isMobile.any()) {
        ...
        function setMouseGalleryStyle() {
            ...
            if (Math.abs(distX) > 0) requestAnimationFrame(setMouseGalleryStyle); else gallery.classList.remove("_init");
        }
